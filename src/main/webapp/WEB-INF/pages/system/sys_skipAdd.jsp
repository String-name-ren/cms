...
<div class="bjui-pageContent">
	<form action="<%=basePath%>/system/white/save.do" class="pageForm"
		...
		<table class="table table-condensed table-hover">
			<tbody>
				<tr>
					...
					<td class="text-left"><input type="text" name="ip" id="ip"
						data-rule="required length[~20] remote[<%=basePath%>/system/white/validateIp.do]"
						size="20" /></td>
				</tr>
				 <tr>
					...
					<td class="text-left"><input type="hidden" name="userId" id="user_id"
						value="${userId}"><input type="text" name="userName" id="user_name"
						value="${userName}" readonly size="15" data-toggle="lookup"
						data-title="选择登录人"
