...
(function () {
    ...
    window.UEDITOR_CONFIG = {
    	...
    	UEDITOR_HOME_URL : basePath + "/ueditor/"
    		...
    		// 图片上传配置区
    	,
    	// imageUrl : basePath + "/cms/content/uploadImage.do" // 图片上传提交地址
    	imageUrl : basePath + "/system/upload/uploadImage.do" // 图片上传提交地址
    	,
...
//        ,videoPath:URL + "jsp/"                   //附件修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', 'inserttable', 'deletetable'],
