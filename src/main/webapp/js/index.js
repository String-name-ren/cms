$(function() {
    BJUI.init({
        ...
        loginInfo    : {url: basePath+'/system/user/login.do', title:'登录', width:450, height:200}, 
        statusCode   : {ok:200, error:300, timeout:301}, // [可选]
        ajaxTimeout  : 180000, // [可选]全局Ajax请求超时时间(毫秒)
        ...
        theme        : 'blue' // 若有Cookie['bjui_theme'],优先选择Cookie['bjui_theme']。皮肤[五种皮肤:default,
...
// 注销
function logout() {
    $(this).alertmsg('confirm', '确定注销吗?',{okCall: function() {
        window.location.href = basePath+"/system/user/login.do";
    }});
}