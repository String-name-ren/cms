...
+function ($) {
    ...
    var BJUI = {
        ...
        loadLogin: function() {
            ...
            //BJUI.dialog({id:'bjui-login', url:login.url, title:login.title, width:login.width, height:login.height, mask:login.mask,onClose:login.onClose})
        },
    ...
    $(function() {
        ...
        $.validator && $.validator.config({
            ...
            rules: {
        		...
        		,invite: [/^[0-9a-zA-Z]{6}$/, '邀请码由6位数字、字母组成']
                ...
                success  : function(response) {
                    ...
                    if (!json[BJUI.keys.statusCode]) {
                        ...
                        if (json[BJUI.keys.statusCode] == BJUI.statusCode.error) {
                            ...
                            BJUI.alertmsg('warn', (json[BJUI.keys.message] || BJUI.regional.sessiontimeout),{autoClose:false,okCall:function(){BJUI.loadLogin()}});
    ...
    Tabledit.prototype.TOOLS = function() {
        ...
        var tools = {
            ...
            initTbody: function() {
                ...
                function _doEdit($tr) {
                	//双击tr失效
                	if($tr.prevObject==undefined || $tr.prevObject=='undefined'){
                		return false;
                	} 
    ...
    Tabledit.prototype.init = function() {
        ...
        $tr.find('> th').each(function() {
            ...
            if (add) {
                ...
                $th.empty()
                that.$numAdd = $('<input type="number" value="1" class="form-control num-add" size="2" title="待添加的行数" >')
